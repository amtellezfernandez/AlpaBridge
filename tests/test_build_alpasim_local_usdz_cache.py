...
from alpabridge.cli.commands.build_alpasim_local_usdz_cache import (
    _existing_by_scene,
    _link_or_copy,
...
class BuildAlpaSimLocalUsdzCacheTests(unittest.TestCase):
    ...
    def test_link_or_copy_falls_back_when_hardlink_fails(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch(
                "alpabridge.cli.commands.build_alpasim_local_usdz_cache.os.link", side_effect=OSError
            ):
    ...
    def test_validate_only_main_is_offline_and_does_not_query_huggingface(self) -> None:
        ...
        self.assertEqual("alpabridge_local_usdz_cache_validation_v1", payload["schema"])
