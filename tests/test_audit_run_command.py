...
def _load_module():
    return importlib.import_module("alpabridge.cli.commands.audit_run")


def _load_script_module():
    spec = importlib.util.spec_from_file_location("alpabridge_audit_run_script", SCRIPT)
...
class AlpaBridgeAuditRunTests(unittest.TestCase):
    ...
    def test_script_can_write_json_report(self) -> None:
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual("alpabridge_run_audit_v1", payload["schema"])
