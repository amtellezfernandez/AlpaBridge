...
from alpabridge.audit import export_alpasim_audit_log, summarize_audit_log
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Summarize a completed AlpaBridge/AlpaSim run and surface camera-pipeline failures."
    )
...
def build_report(*, run_dir: Path, audit_dir: Path | None = None) -> dict[str, Any]:
    ...
    report = {
        "schema": "alpabridge_run_audit_v1",
        "valid": valid,
        "run_dir": str(run_dir),
