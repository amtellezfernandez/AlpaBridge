...
class DirectActorPlannerAlpaSimModel(BaseTrajectoryModel):
    ...
    def from_config(
        ...
        return cls(
            ...
            oracle_actor_proxy_tolerance_us=int(
                os.getenv(
                    "ALPABRIDGE_DIRECT_PLANNER_ORACLE_ACTOR_PROXY_TOLERANCE_US",
    ...
    def predict(self, prediction_input: PredictionInput) -> ModelPrediction:
        ...
        reasoning_payload = {
            "scene_id": prediction_scene_id(prediction_input),
            "adapter": "alpabridge.simulator.alpasim_direct_actor_planner",
            "command": command,
