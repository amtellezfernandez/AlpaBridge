...
| `make conformance PYTHON=./.venv/bin/python` | Passed: 243 passed, 14 skipped, 15 subtests passed. |
...
| Selection | Result |
|---|---|
| `tests -k "semantic or route"` | 10 passed, 247 deselected. |
| `tests -k "temporal or resampl"` | 10 passed, 247 deselected, 15 subtests passed. |
| `tests -k "lifecycle or session"` | 10 passed, 247 deselected. |
| `tests -k "plugin or entry_point"` | 5 passed, 252 deselected. |
| `tests -k "deployment or readiness or launch"` | 20 passed, 237 deselected. |
| `tests -k "evidence or audit or benchmark"` | 19 passed, 238 deselected. |
| `tests -k "fault"` | 5 passed, 252 deselected. |
