...
def package(args: argparse.Namespace) -> dict[str, Any]:
    ...
    manifest = {
        "schema": "alpabridge_alpasim_navsim_reactive_evidence_v1",
        "run": {
            ...
            "alpabridge_commit": args.alpabridge_commit,
        },
        "fixture": {
            ...
            "derived_surface": {
                "files_added": ["mesh.ply", "mesh_ground.ply", "ALPABRIDGE_DERIVATION.json"],
            ...
            "camera_map": {
                **video_metadata,
                "content": (
                    ...
                    "camera panel has no AlpaBridge text overlay"
                ),
                "path": (
...
def main() -> int:
    ...
    parser.add_argument("--alpabridge-commit", required=True)
